...
// === تعديل 1: تغيير رابط API لاستهداف Gemini 2.5 Pro ===
// تم استخدام لاحقة -latest لضمان استهداف أحدث نسخة مستقرة من الطراز
...
// === تعديل 2: تحديث الحدود لتطابق Gemini 2.5 Pro ===
// هذه هي الحدود الصحيحة للطبقة المجانية لطراز 2.5 Pro
const QUOTA_LIMITS = {
...
app.listen(PORT, () => {
  ...
  // === تعديل 3: إضافة سطر التأكيد عند التشغيل ===
